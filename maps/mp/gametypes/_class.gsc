...
giveLoadout( team, class, allowCopycat )
{
	...
	// no such thing as isArray has ever existed. liars.
//	if ( isArray( class ) )
	if ( !isString( class ) )
	{
		loadoutPrimary = class["loadoutPrimary"];
		loadoutPrimaryAttachment = class["loadoutPrimaryAttachment"];
		loadoutPrimaryAttachment2 = class["loadoutPrimaryAttachment2"] ;
		loadoutPrimaryCamo = class["loadoutPrimaryCamo"];
		loadoutSecondary = class["loadoutSecondary"];
		loadoutSecondaryAttachment = class["loadoutSecondaryAttachment"];
		loadoutSecondaryAttachment2 = class["loadoutSecondaryAttachment2"];
		loadoutSecondaryCamo = class["loadoutSecondaryCamo"];
		loadoutEquipment = class["loadoutEquipment"];
		loadoutPerk1 = class["loadoutPerk1"];
