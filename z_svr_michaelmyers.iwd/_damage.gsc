...
PlayerKilled_internal( eInflictor, attacker, victim, iDamage, sMeansOfDeath, sWeapon, vDir, sHitLoc, psOffsetTime, deathAnimDuration, isFauxDeath )
{
	...
	{
		level.lastKill = [];
		level.lastKill[0] = victim;
		level.lastKill[1] = attacker;
		level.lastKill[2] = attackerNum;
		level.lastKill[3] = killcamentityindex;
		level.lastKill[4] = killcamentitystarttime;
		level.lastKill[5] = sWeapon;
		level.lastKill[6] = deathTimeOffset;
		level.lastKill[7] = psOffsetTime;
